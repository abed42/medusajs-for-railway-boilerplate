...
export default function Nav() {
  ...
  if (!creditContext) {
    ...
    // Handle the case where CreditContext is undefined, possibly by rendering a loading indicator or returning early
    return null; // Or return a loading spinner, etc.
  }
  
  // Now TypeScript knows creditContext is defined, so it's safe to destructure credit from it
        ...
        <nav className="content-container txt-xsmall-plus text-ui-fg-subtle flex items-center justify-between w-full h-full text-small-regular">
          ...
          <div className="flex items-center gap-x-6 h-full flex-1 basis-0 justify-end">
           ...
           <div className="flex">
              ...
              <span >
              {credit !== null ? JSON.stringify(credit) : 'Loading...'} Credits
              </span>
           </div>
